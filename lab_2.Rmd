...
With this in mind - we would like to determine the key drivers to app downloads on the Google Play Store using a fairly robust dataset from 2019 that contains records of ~10,000 available at the Google Play Store. This dataset allows to analyze the potential levers to app downloads such as average review/rating, price, app size, app category, etc. 
Wit this dataset, we will build a statistical model to determine the importance (or unimportance) on each of these variables and more on app downloads. 
