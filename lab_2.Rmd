...
**Price — `price`**: `r round(mean(data_clean$is_free),2)*100`% of the applications are free. This is why believe both distributions of price and log(price) are undesirable where neither mimic a normal distribution at all. This finding lead to us exploring the concept of a binary metric variable where 1 means it is paid and 0 means it is not paid. 
