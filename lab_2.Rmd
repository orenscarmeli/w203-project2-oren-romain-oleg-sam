...
With this in mind - we would like to determine the key drivers to app downloads on the Google Play Store using a fairly robust dataset from [Kaggle](https://www.kaggle.com/lava18/google-play-store-apps) from 2019 that contains records of ~10,000 apps available from the Google Play Store. 
